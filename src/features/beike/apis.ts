...
const condition = [
  ...
  { name: '综合1（3房朝南近地铁总套数）', value: 'l3f2su1', key: 'total_3room_south_subway' },
 ...
 * @returns 
 */
export const getDataByErshou = async (district_id?: number | string, district_name?: string, district_pinyin?: string) => {
  const params = {
    city_id: cityId,
